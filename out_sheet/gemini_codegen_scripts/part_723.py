...
def create_part_dxf(output_filename):
    ...
    # Part 723: Diagonal Member / Flat Bar
    # Dimensions: L 790x15 (Length 790mm, Width 15mm, Thickness 15mm)
    ...
    # Annotations
    msp.add_mtext("PART 723 - Diagonal Member", dxfattribs={"layer": "ANNOTATION"}).set_location((length / 2, width + 20), rotation=0, attachment_point=5)
