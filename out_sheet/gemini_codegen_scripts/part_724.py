...
def create_part_dxf(output_filename):
    ...
    # Part 724: Horizontal Member / Flat Bar
    # Dimensions: L 1090x15 (Length 1090mm, Width 15mm, Thickness 15mm)
    ...
    # Annotations
    msp.add_mtext("PART 724 - Horizontal Member", dxfattribs={"layer": "ANNOTATION"}).set_location((length / 2, width + 20), rotation=0, attachment_point=5)
